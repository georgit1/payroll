...
const Open = ({ children, opens: opensWindowName }: ModalOpenProps) => {
...
const Window = ({ children, name }: ModalWindowProps) => {
  ...
  return createPortal(
    <Overlay>
      <StyledModal ref={ref as React.LegacyRef<HTMLDivElement>}>
